...
namespace LuceneNetDemo02.Data
{
    ...
    public static class SampleDataRepository
    {
        ...
        public static List<SampleData> GetAll()
        {
            return new List<SampleData>
            {
                ...
                new SampleData {Id = 6, Name = "Ahmed", Description = "Employee of Goformz"},
                new SampleData {Id = 7, Name = "Jason", Description = "Founder of Goformz"},
            };
        }
    }
}
